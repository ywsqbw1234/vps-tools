...
main() {
...

  {
    ...
    echo "  - PROCESS-NAME,matlab,DIRECT"
    echo "  - PROCESS-NAME,MathWorksServiceHost.exe,DIRECT"
    echo "  - PROCESS-NAME,MathWorksProductAuthorizer.exe,DIRECT"
    ...
    echo "  - DOMAIN-SUFFIX,mathworks.com,DIRECT"
    ...
    echo "  - DOMAIN-SUFFIX,sentry.io,ChatGPT"
    ...
    echo "  - AND,((NETWORK,UDP),(OR,((DOMAIN-KEYWORD,google),(DOMAIN-KEYWORD,gemini),(DOMAIN-KEYWORD,gvt),(DOMAIN-KEYWORD,firebase)))),REJECT"
    echo "  - PROCESS-NAME,com.google.android.apps.bard,Google"
    echo "  - PROCESS-NAME,com.google.android.googlequicksearchbox,Google"
    echo "  - PROCESS-NAME,com.google.android.gms,Google"
    echo "  - PROCESS-NAME,com.google.android.gsf,Google"
    echo "  - PROCESS-NAME,com.android.vending,Google"
    echo "  - PROCESS-NAME,com.google.android.webview,Google"
    echo "  - PROCESS-NAME,com.google.android.apps.chrome,Google"

    echo "  - DOMAIN-KEYWORD,google,Google"
    echo "  - DOMAIN-KEYWORD,gemini,Google"
    echo "  - DOMAIN-KEYWORD,bard,Google"
    echo "  - DOMAIN-KEYWORD,firebase,Google"
    echo "  - DOMAIN-KEYWORD,gvt,Google"

    echo "  - DOMAIN,gemini.google.com,Google"
    echo "  - DOMAIN,bard.google.com,Google"
    echo "  - DOMAIN,generativelanguage.googleapis.com,Google"
    echo "  - DOMAIN,aistudio.google.com,Google"
    echo "  - DOMAIN,ai.google.dev,Google"
    echo "  - DOMAIN,makersuite.google.com,Google"
    echo "  - DOMAIN,mtalk.google.com,Google"
    ...
    echo "  - DOMAIN-SUFFIX,ai.google.dev,Google"
    echo "  - DOMAIN-SUFFIX,google.dev,Google"
    ...
    echo "  - DOMAIN-SUFFIX,1e100.net,Google"

    echo "  - DOMAIN-SUFFIX,android.com,Google"
    echo "  - DOMAIN-SUFFIX,googleandroid.com,Google"
    echo "  - DOMAIN-SUFFIX,gvt1.com,Google"
    echo "  - DOMAIN-SUFFIX,gvt2.com,Google"
    echo "  - DOMAIN-SUFFIX,gvt3.com,Google"

    echo "  - DOMAIN-SUFFIX,firebaseio.com,Google"
    echo "  - DOMAIN-SUFFIX,firebaseapp.com,Google"
    echo "  - DOMAIN-SUFFIX,app-measurement.com,Google"
    echo "  - DOMAIN-SUFFIX,crashlytics.com,Google"

    echo "  - DOMAIN-SUFFIX,doubleclick.net,Google"
    echo "  - DOMAIN-SUFFIX,googletagmanager.com,Google"
    echo "  - DOMAIN-SUFFIX,googlesyndication.com,Google"
    echo "  - DOMAIN-SUFFIX,googleadservices.com,Google"
